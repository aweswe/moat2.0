            ...
            <svg className="absolute inset-0 w-full h-full overflow-visible" viewBox="0 0 600 400">
                ...
                <motion.path
                    ...
                    animate={{
                        ...
                        stroke: t > 0.4 ? "hsl(var(--muted-foreground))" : "hsl(var(--primary))"
                    }}
                ...
                <motion.g animate={{ opacity: isCrashed && t < 0.8125 ? 1 : 0 }}>
                    ...
                    {t >= 0.1875 && t < 0.275 && (
                        <motion.circle
                            cx="400" cy="200" stroke="#ef4444" strokeWidth="1" fill="none"
                ...
                <motion.g animate={{ opacity: isShipped && t < 0.8125 ? 1 : 0 }}>
                    ...
                    {/* Success Pulse */}
                    <motion.circle
                        cx="550" cy="120" stroke="#22c55e" strokeWidth="1" fill="none"
                        initial={{ r: 6, opacity: 1 }}
                        animate={{ r: 30, opacity: 0 }}
