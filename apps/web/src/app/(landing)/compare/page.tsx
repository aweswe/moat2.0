            ...
            <div className="container max-w-5xl mx-auto px-4">
                            ...
                            <tbody className="divide-y divide-border">
                                ...
                                <tr className="hover:bg-muted/20 transition-colors">
                                    ...
                                    <td className="p-4 text-right">
                                        <Link href="/compare/agenttrace-vs-sentry" className="text-sm font-medium text-brand hover:underline">Compare →</Link>
                                    </td>
                                </tr>
                                <tr className="hover:bg-muted/20 transition-colors">
                                    ...
                                    <td className="p-4 text-center"><div className="flex justify-center"><X className="w-5 h-5 text-muted-foreground/30" /></div></td>
                                    <td className="p-4 text-right">
                                        <Link href="/compare/agenttrace-vs-langsmith" className="text-sm font-medium text-brand hover:underline">Compare →</Link>
                                    </td>
                                </tr>
                                <tr className="hover:bg-muted/20 transition-colors">
                                    ...
                                    <td className="p-4 text-center"><div className="flex justify-center"><AlertTriangle className="w-5 h-5 text-yellow-500/70" /></div></td>
                                    <td className="p-4 text-right">
                                        <Link href="/compare/agenttrace-vs-replay" className="text-sm font-medium text-brand hover:underline">Compare →</Link>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="p-6 rounded-xl border border-border hover:border-brand/50 transition-colors cursor-pointer group">
                        ...
                        <Link href="/compare/agenttrace-vs-sentry" className="inline-flex items-center text-brand font-medium group-hover:translate-x-1 transition-transform">
                    ...
                    <div className="p-6 rounded-xl border border-border hover:border-brand/50 transition-colors cursor-pointer group">
                        ...
                        <Link href="/compare/agenttrace-vs-langsmith" className="inline-flex items-center text-brand font-medium group-hover:translate-x-1 transition-transform">
