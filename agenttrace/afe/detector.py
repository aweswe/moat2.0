...
class AFEDetector:
    ...
    def detect_failure(self, job_id: str, trace_id: str, error_details: str, traceback_str: str = None, events_path: str = None, org_id: str = None):
        """
        ...
        try:
            ...
            data = {
                ...
                "org_id": org_id  # Required for RLS access
            }
            ...
            if candidates:
                ...
                for cand in candidates:
                    ...
                    cand_data["org_id"] = org_id # Ensure RLS consistency
